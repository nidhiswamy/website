    ...
    <>
      <div className="relative container justify-center mx-auto my-8 lg:mt-20">
        ...
        <div className="justify-items-center grid grid-cols-1 gap-y-6 md:gap-y-8 lg:gap-y-4 md:grid-cols-2 lg:grid-cols-3 md:gap-x-0.5">
          {jobs.map((job) => {
            return (
              <div className="p-4 sm:p-1 rounded-md border border-slate-600 shadow sm:shadow-none sm:border-0">
                <WorkCard 
                  company={job.company}
                  link={job.link}
                  title={job.title}
      ...
      <div className="container mx-auto my-8 justify-center">
        ...
        {projects.map((project) => {
          return (
           <div className="p-4 sm:p-1 rounded-md border border-slate-600 sm:border-0">
              <ProjectCard 
                 name={project.name}
                 link={project.link}
                 desc={project.desc}                 
