  ...
  return (
    <div className="relative flex justify-between items-center size-2/3 mx-auto mt-16">
      <div className="place-self-start size-2/3 text-white text-2xl font-normal font-alegreya">
        Hey there!
        <br/><br/>
        I’m Nidhi Swamy, a recent Bachelor's in Computer Science graduate from the Pennsylvania State University. I was born and raised in Bangalore, India. Since middle school, I’ve dreamed about moving to the United States to complete my education and begin my work life. 
        <br/><br/>
