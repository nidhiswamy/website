...
export default function BlogPost(props: BlogProps) {
  return (
    <Link
      ...
      className={`${props.visibility} h-min sm:h-full w-72 sm:w-full transition-none sm:transition sm:hover:bg-secondary-light/[0.4] sm:hover:shadow-xl duration-300 ease-in-out`}
    >
