...
export default function Blog() {
  return (
      <div>
        <h1 className="mt-2 sm:mt-4 mx-auto w-full lg:w-2/3 text-sm sm:text-xl text-start sm:text-center lg:whitespace-pre-line pb-4">{blogBlurb}<span className="font-bold text-secondary">Enjoy :)</span></h1>
